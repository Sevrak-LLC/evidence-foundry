...
public class DisclaimerDialog : Form
{
    ...
    private const string DisclaimerRtf = @"{\rtf1\ansi\deff0
{\fonttbl{\f0\fswiss\fcharset0 " + UiFontFamily + @";}}
...
\par
    ...
    private void InitializeUI()
    {
        ...
        _btnDecline.Font = new Font(UiFontFamily, 10F);
        ...
        _btnAccept.Font = new Font(UiFontFamily, 10F, FontStyle.Bold);
